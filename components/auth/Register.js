            ...
            <div className="mt-6">
                <div className="space-y-4 grid grid-cols-2 gap-x-4">
                    <div className='col-span-full'>
                        ...
                        <div className="mt-2">
                            <input id="email" onChange={handleEmailChange} name="email" type="email" placeholder="sanchir@mail.mn" required autoFocus className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset bg-dark-800 ring-dark-700 placeholder:text-dark-500 focus:ring-2 focus:ring-inset focus:ring-dark-100 sm:text-sm sm:leading-6" />
                        </div>
                    </div>

                    <div className='col-span-full sm:col-span-1'>
                        <label htmlFor="lastName" className="block text-sm font-medium leading-6 text-dark-50">
                            Овог
                        </label>
                        <div className="mt-2">
                            <input id="lastName" onChange={handleLastNameChange} name="lastName" type="text" placeholder="Таны овог" required className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset bg-dark-800 ring-dark-700 placeholder:text-dark-500 focus:ring-2 focus:ring-inset focus:ring-dark-100 sm:text-sm sm:leading-6" />
                        </div>
                    </div>

                    <div className='col-span-full sm:col-span-1'>
                        <label htmlFor="firstName" className="block text-sm font-medium leading-6 text-dark-50">
                            Нэр
                        </label>
                        <div className="mt-2">
                    ...
                    <div className='pt-2 col-span-full'>
                        { loading ? (
                            <button type="button" className="flex w-full justify-center rounded-md bg-dark-100 px-3 py-1.5 text-sm font-semibold leading-6 text-dark-800 shadow-sm hover:bg-dark-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark-100" >
                                Уншиж байна ...
                            </button>
                        ) : (
                            <button type="button" onClick={handleRegister} className="flex w-full justify-center rounded-md bg-dark-100 px-3 py-1.5 text-sm font-semibold leading-6 text-dark-800 shadow-sm hover:bg-dark-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark-100" >
                                Бүртгүүлэх
                            </button>
                        ) }
                    </div>
                ...
                <div className="relative mt-6">
                    ...
                    <div className="relative flex justify-center text-sm font-medium leading-6">
                        <span className="bg-dark-950 px-6 text-dark-100">Эсвэл</span>
                    </div>
                </div>
                ...
                <p className="mt-6 text-sm leading-6 text-dark-300 text-center">
                    Аль хэдийн бүртгэлтэй юу?{' '}
                    <span onClick={routeToLogin} className="cursor-pointer font-semibold text-dark-100 hover:text-dark-200 ml-1">
                        Нэвтрэх
                    </span>
                </p>
            </div>
